...
def create_form_model(
    ...
    Under_Manufacturer_Warranty: YesOrNo = Form(...),
    Recently_Serviced: YesOrNo = Form(...),
    Service_Info: Optional[str] = Form(""),
    Require_PO_number: YesOrNo = Form(...),
    Purchase_Order_Number: Optional[str] = Form(""),
    Location: str = Form(...),
    Type: EquipmentType = Form(...),
    Description: str = Form(...),
    Preferred_Date: str = Form(...),
    Preferred_Time: PreferredTime = Form(...),
    OT_Approved: YesOrNo = Form(...),
